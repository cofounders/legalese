...
***** terms
***** config
***** entitiesByName: a dictionary of entityNames to Entities
...
because it is in entitiesByName, it becomes available to the includer when the includer starts defining Roles.
