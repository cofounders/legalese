...
* TODO concatenate PDFs doesn't quite do the right thing -- ensure individual docs don't each get the full set of recipients
* for Kark
...
* for 2015a
** TODO add a director's consent to legalese
** TODO update the creation of class f agreements for those teams that have already incorporated. create new sheet for those. create ROLES rows.
- Taembe.com
- Bakipa
- BoxGreen
** TODO draft paperwork to effect share exchange with Indian shareholders
...
** TODO review articles of association from 2013B and see if there are significant omissions in our 2015a version.
** TODO reformat all of Table A into the articles of association so we have something that's submissible to banks and so on
...
** TODO merge employment agreement and internship agreement into volunteer agreement
...
** TODO the issue of securities to JFDI needs to be preceded by section 161 workflow, with resolutions of directors and members.
